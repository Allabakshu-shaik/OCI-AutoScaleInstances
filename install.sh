...
git clone https://github.com/Allabakshu-shaik/OCI-AutoScaleInstances
cd OCI-AutoScale/
sed -i 's/UseInstancePrinciple = False/UseInstancePrinciple = True/g' AutoScaleInstances.py
